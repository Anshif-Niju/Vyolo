                ...
                <div className="flex items-center justify-between  bg-white backdrop-blur-md border border-white/40 shadow-lg px-6 py-3 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-2">
                        <Link to="/home" onClick={scrollTop} className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-black tracking-wide text-[#1D3557]">
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        {/* Rent Button - Changed to solid pill style */}
                        <Link to="/cart" className="hidden h-9 sm:block px-5 py-2 text-white text-sm font-bold rounded-full bg-[#457b9d] hover:bg-[#36607a] shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                            Go Cart
                        </Link>
                        ...
                        <div className="relative flex items-center gap-2">
                            ...
                            {profileOpen && (
                                <div className="absolute right-0 top-[55px] bg-white border border-slate-100 rounded-2xl shadow-xl w-48 p-2 animate-slideDown overflow-hidden">
                                    ...
                                    <Link className="block px-4 py-2 text-sm font-medium text-slate-600 hover:text-[#457b9d] hover:bg-slate-50 rounded-lg transition">
                                        My Orders
                                    </Link>
                                    <button
                ...
                {open && (
                    <div className="md:hidden mt-2 mx-2 rounded-3xl bg-white/90 backdrop-blur-xl border border-white/20 shadow-2xl p-6 animate-slideDown">
                        <ul className="flex flex-col gap-4 text-center">
                            ...
                            <li>
                                <Link to="/shop" className="block text-lg font-medium hover:font-bold text-slate-600 py-2">
                                    Shop
                                </Link>
                            </li>
                            <li>
                                <Link to="" className="block text-lg font-medium hover:font-bold text-slate-600 py-2">
                                    Rent
                                </Link>
                            </li>
                            <li>
