        ...
        <div className="min-h-screen flex items-center justify-center bg-[#F1FAEE] px-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-blue-900/10 relative z-10 border border-slate-100">
                <div className="text-center mb-8">
                    <h2 className="text-4xl font-black text-[#1D3557] tracking-tight">Welcome Back</h2>
                    <p className="text-slate-400 mt-2 font-medium">Login to your account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="group">
                        <label className="block text-sm font-bold text-[#1D3557] mb-2 ml-1">Password</label>
                        <input
                            type="password"
                            placeholder="••••••••"
                            name="pass"
                    ...
                    {error && <p className="text-center text-xs font-bold text-red-500 bg-red-50 py-2 rounded">{error}</p>}

                    <div className="flex items-center justify-end text-sm">
                        <Link to="/forget" className="text-slate-500 hover:text-[#457b9d] font-semibold transition-colors">
                            Forgot password?
                        </Link>
                    </div>
                ...
                <p className="text-center text-sm text-slate-500 mt-8 font-medium">
                    ...
                    <Link
                        to="/register"
                        replace
                        className="text-[#1D3557] font-bold hover:text-[#457b9d] hover:underline transition-all ml-1"
                    >
                        Register
                    </Link>
                </p>
