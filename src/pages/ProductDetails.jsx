        ...
        <div className="min-h-screen bg-[#F1FAEE] text-slate-800 p-6 pt-24 relative overflow-x-hidden">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-8">
                    ...
                    <h2 className="text-4xl font-black text-[#457b9d]">{product.price}</h2>

                    <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-[#1D3557] uppercase tracking-wide">Quantity</label>
                        <div className="flex items-center gap-4 bg-white border border-slate-200 w-fit p-2 rounded-xl shadow-sm">
                            ...
                            <span className="text-xl font-bold text-[#1D3557] min-w-[30px] text-center">{qty}</span>
                        ...
                        {msg && <p className="text-red-500 text-sm font-bold bg-red-50 w-fit px-2 py-1 rounded">{msg}</p>}
                    </div>

                    <div className="flex flex-wrap gap-4 pt-4 border-t border-slate-200">
                        <Link to="/cart">
                            <button className="flex-1 bg-[#457b9d] hover:bg-[#36607a] text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-blue-900/20 transition-all hover:-translate-y-1">
                                Add to Cart
                            </button>
                        </Link>
                    ...
                    <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm mt-8">
                        ...
                        <ul className="text-slate-600 space-y-2 font-medium">
                            <li className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#457b9d]"></span>Processor: Apple M4 Chip
                            </li>
                            <li className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#457b9d]"></span>RAM: 16GB
                            </li>
                            <li className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#457b9d]"></span>Storage: 512GB SSD
                            </li>
                            <li className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#457b9d]"></span>Display: 13.6″ Retina
                            </li>
                            <li className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#457b9d]"></span>Battery: Up to 18 hours
                            </li>
                        </ul>
                    </div>
                </div>
